...
<% request.setCharacterEncoding("UTF-8");
    int maxTime = 100 * 60 * 1000;        //设置5分钟不说话，将其踢出聊天室
%>
...
<head>
    ...
    <script>
        ...
        var sysBBS = "<span style='font-size:15px; line-height:30px;'>欢迎光临匿名聊天室，聊天数据不会保存，可随意畅聊。</span>" +
            "<br>" +
...
<%--    </div>--%>
    ...
    <div class="footer">
        <form action="" name="chatForm" method="post">
            ...
            <input name="toWhoText" type="text" value="" size="25" readonly="readonly">
            <select name="faceSelector" class="selector">
                <option value="" selected>无表情</option>
                <option value="面无表情的">面无表情的</option>
        ...
        <div style="text-align: right">modify by benyue</div>
    </div>
</div>
</body>
</html>
